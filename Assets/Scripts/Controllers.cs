...
public static class Controllers
{
    ...
    public static class xBox360
    {
        ...
        {
            public static string ShootButton1(string num) { return "joystick " + num + " button 5"; }
            public static string ShootButton2(string num) { return "joystick " + num + " button 0"; }
        ...
        {
            public static string ShootButton1(string num) { return "joystick " + num + " button 14"; }
            public static string ShootButton2(string num) { return "joystick " + num + " button 16"; }
            public static string MoveAxisX(string num) { return "Joystick " + num + " X axis"; }
            public static string MoveAxisY(string num) { return "Joystick " + num + " Y axis"; }
