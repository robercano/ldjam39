...
public class AgentManager : MonoBehaviour {
    ...
    private PlayerBatteryManager refOpposingPlayerBatteryManager;
	private PlayerFistAttack refPlayerFistAttack;
    private Fortress refPlayerFortress;
    private Fortress refOpposingPlayerFortress;
    ...
    void Start () {
        ...
        this.refOpposingPlayerFortress = GameObject.Find((this.tag == "Blue") ? "RedBase" : "BlueBase").GetComponent<Fortress>();
        this.refOpposingPlayerHealth = this.refOpposingPlayer.GetComponent<PlayerHealth>();
        this.refOpposingPlayerBatteryManager = this.refOpposingPlayer.GetComponent<PlayerBatteryManager>();
